let initPhotoSwipeFromDOM = function (gallerySelector, swipeDivId) {
  ...
  var onThumbnailsClick = function (e) {
    ...
    var clickedGallery = closest(clickedListItem, function (el) {
      return el.className && "." + el.className === gallerySelector;
    });
    ...
    if (index >= 0) {
      ...
      openPhotoSwipe(swipeDivId, index, clickedGallery);
    }
    return false;
  };
  ...
  var openPhotoSwipe = function (
    ...
    var pswpElement = document.getElementById(swipeDivId),
      gallery,
      options,
      items;
