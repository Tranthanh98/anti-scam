      ...
      >
        <Box>
          ...
          >
            ...
            <Box margin="8px 0">
              Bước 2. Tại form báo cáo lừa đảo click vào nút thả xuống tại ô Thể
              loại lừa đảo, chọn thông tin của kẻ lừa đảo mà bạn đang có (SDT,
              STK, LINK,...) sau đó chọn THÊM, tiếp tục điền các phần còn lại
              như Tiêu đề (VD: cảnh giác lừa đảo ví điện tử,...), Mô tả và cuối
              cùng là XÁC NHẬN và gửi báo cáo.
              <Box
                margin="8px 0"
                width="100%"
                display="flex"
