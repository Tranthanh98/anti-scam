...
function ReportPage(props) {
    ...
    return (
        <Box padding={widthScreen > 1280 ? "0 48px" : undefined} display="flex" justifyContent="center">
                        ...
                        <CardContent>
                            ...
                            <Grid item xs={12}>
                                <Box display="flex" justifyContent="flex-end" width="100%">
                                    <Button onClick={_onClickReport} variant="contained" color="primary">
                                        Báo cáo lừa đảo
                                </Button>
                                </Box>
                            </Grid>
            ...
            <Box padding="12px 0" width="25%" className={clsx(isMobile && classes.hide)}>
                <SummaryProfile />
                <Box margin="8px 0">
                    <HighLightReputation />
                </Box>
