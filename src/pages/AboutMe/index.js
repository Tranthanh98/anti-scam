      ...
      >
        <Box>
          ...
          >
            ...
            nhiều ý kiến đóng góp của cộng đồng để phát triển tốt hơn. Bạn có
            bao giờ sử dụng một dịch vụ/mua sắm trên mạng và được yêu cầu chuyển
            khoản đặt cọc trước? Hay bạn có bao giờ tức giận vì sản phẩm từ các
            Shop trên Facebook/Website có chất lượng không đúng như họ quảng cáo
            nhưng liên hệ lại thì không được hỗ trợ? Với sứ mệnh giúp người dùng
            tránh khỏi những tình trạng đó, chúng tôi đã lập nên một Website để
            mọi người có thể báo cáo những Website, Tài khoản mạng xã hội, tài
            khoản ngân hàng, hay số điện thoại lừa đảo, từ đó những người dùng
            khác có thể tra cứu thông tin để kiểm tra một nhân tố nào đó có khả
            năng lừa đảo hay không. Bất kì ai đã bị lừa đảo đều có thể báo cáo
            tại Website của chúng tôi. Nếu bạn thật sự không thích lừa đảo, hãy
            giúp những người khác tránh được nó bằng cách chia sẻ chúng ở đây.
          </Box>
          <Box textAlign="center" fontWeight="bold" fontSize="20px">
            Liên Hệ
          </Box>
